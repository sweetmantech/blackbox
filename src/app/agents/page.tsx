  ...
  return (
    <div className="min-h-screen bg-[#212121] p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-[#cfcfcf] mb-2">Select Your Agent</h1>
          <p className="text-gray-400">Choose from our specialized agents to build your dream team</p>
        </div>
