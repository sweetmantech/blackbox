...
export const agents: Agent[] = [
  {
    ...
    type: 'HR',
    description: 'Expert in talent acquisition, employee relations, and HR compliance',
  ...
  },
  {
    ...
    type: 'Marketing',
    description: 'Digital marketing expert specializing in growth and brand development',
  ...
  },
  {
    ...
    title: 'Legal Counsel',
    type: 'Legal',
    description: 'Business and startup law specialist with focus on compliance and contracts',
